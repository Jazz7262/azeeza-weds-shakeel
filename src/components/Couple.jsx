                    ...
                    <div className="col-lg-5" data-aos="fade-up">
                        ...
                        <div className="info groom-info">
                            ...
                            <p className="mt-2 mt-lg-3">
                                Profession:{" "}
                                <strong>IT Release Manager - TCS,</strong>
                            ...
                            <p className="mt-2 mt-lg-3">
                                S/O. Janab{" "}
                                <strong>Mandi Basheer Ahmed Sahab,</strong>{" "}
                            </p>
              ...
              <p className="mt-1 mt-lg-2">APSRTC, Adoni.</p>*/}
                    ...
                    <div className="col-lg-5" data-aos="fade-up">
                        ...
                        <div className="info bride-info">
                            ...
                            {/* <p className="mt-2 mt-lg-3">
                                Grand D/O{" "}
                                <strong>Janab S.P. Abdul Ghaffar Sahab,</strong>
                            </p>
                            <p className="mt-2 mt-lg-3">
                                Maternal Grand D/O{" "}
                                <strong>Janab P. Mohammed Sahab,</strong>
                            </p> */}
                            <p className="mt-1 mt-lg-2">
                                 D/O Janab{" "}
